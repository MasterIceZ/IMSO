...
void solve() {
  ...
  ll bob_number_special = (k - alice_number_special) % MOD;
  ll bob_special_expected = (bob_number_special * ((sum_special * inverse_divide(k)) % MOD)) % MOD;
  ll bob_number_normal = (n - k - alice_number_normal) % MOD;
  ll bob_normal_expected = (bob_number_normal * ((sum_normal * inverse_divide(n - k)) % MOD)) % MOD;
  ll bob_answer = (((bob_special_expected + bob_normal_expected) % MOD) + MOD) % MOD;
